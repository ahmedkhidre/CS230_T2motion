...
def main():
    ...
    encodings_test = encoder.predict(tf.reshape(Y_test_flat, (Y_test_flat.shape[0], 200, NUM_JOINTS * COORDS )))
    encodings_train = encoder.predict(tf.reshape(Y_train_flat, (Y_train_flat.shape[0], 200, NUM_JOINTS * COORDS )))
